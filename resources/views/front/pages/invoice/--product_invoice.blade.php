...
<head>
    ...
    <!-- Title -->
    <title>{{ $productOrder->name }} Invoice</title>
                            ...
                            <tr>
                                <td align="center">
                                    <div class="editable-img">
                                        <img editable="true" mc:edit="image003" src="{{ asset('email/images/circle-icon-basket.png') }}"  style="display:block; line-height:0; font-size:0; border:0;" border="0" alt="" />
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td mc:edit="text002" align="center" class="text_color_ffffff" style="color: #ffffff; font-size: 12px; font-weight: 300; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
                                    <div class="editable-text">
										<span class="text_container">
											<multiline>
												{{ \Carbon\Carbon::parse($productOrder->created_at)->format('d M, Y') }}
											</multiline>
										</span>
                                    </div>
                                </td>
                        ...
                        <table class="table1" width="520" align="center" border="0" cellspacing="0" cellpadding="0" style="margin: 0 auto;">
                            ...
                            <tr>
                                <td mc:edit="text003" align="left" class="center_content text_color_282828" style="color: #282828; font-size: 18px; font-weight: 700; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
                                    <div class="editable-text">
										<span class="text_container">
											<multiline>Hello {{ $productOrder->username }} here is Your Cart ,</multiline>
										</span>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td mc:edit="text004" align="left" class="center_content text_color_282828" style="color: #282828; font-size: 14px;line-height: 2; font-weight: 500; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
                                    <div class="editable-text" style="line-height: 2;">
										<span class="text_container">
											<multiline>
												Here is a summary of your recent order made on {{ \Carbon\Carbon::parse($productOrder->created_at)->format('d M, Y') }}. You can also view your order in the <strong>Purchases</strong> section of your <strong>account</strong>.
											</multiline>
										</span>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table class="table1-2" width="125" align="left" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="center">
                                                <a href="{{ route('get:product_detail', $productOrder->slug) }}" style="border-style: none !important; display: block; border: 0 !important;" class="editable-img">
                                                    <img editable="true" mc:edit="image004" src="{{ asset('100ProductImg/'.$productOrder->product_img) }}" style="display:block; line-height:0; font-size:0; border:0;" border="0" alt="" />
                                                </a>
                                            </td>
                                        </tr>
                                        <!-- margin-bottom -->
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <table class="table1-2" align="left" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <tr>
                                                        <td mc:edit="text010" align="left" class="center_content text_color_303f9f" style="color: #303f9f; font-size: 12px; font-weight: 400; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
                                                            <div class="editable-text">
																<span class="text_container">
																	<multiline>Rs. {{ $productOrder->price }}</multiline>
																</span>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td mc:edit="text011" align="left" class="center_content text_color_303f9f" style="color: #303f9f; font-size: 12px; font-weight: 400; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
                                                            <div class="editable-text">
																<span class="text_container">
																	<multiline>{{ $productOrder->quantity }}</multiline>
																</span>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td mc:edit="text012" align="left" class="center_content text_color_303f9f" style="color: #303f9f; font-size: 12px; font-weight: 400; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
                                                            <div class="editable-text">
																<span class="text_container">
																	<multiline>Rs. {{ $productOrder->quantity * $productOrder->price }}</multiline>
																</span>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                ...
                                                <table class="table1-2" align="right" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td>
                                                            <table class="button_bg_color_303f9f center_button" bgcolor="#303f9f" width="80" height="30" align="center" border="0" cellpadding="0" cellspacing="0" style="background-color:#303f9f; border-radius:3px;">
                                                                <tr>
                                                                    <td mc:edit="text013" align="center" valign="middle" style="color: #ffffff; font-size: 12px; font-weight: 400; font-family: 'Open Sans', Helvetica, sans-serif; mso-line-height-rule: exactly;" class="text_color_282828">
                                                                        <div class="editable-text">
																			<span class="text_container">
																				<multiline>
																					<a href="{{ route('get:product_detail', $productOrder->slug) }}" style="text-decoration: none; color: #ffffff;">Read More</a>
																				</multiline>
																			</span>
                                                                        </div>
                                                                    </td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center" width="30">
                                                <a href="#" style="border-style: none !important; display: inline-block;; border: 0 !important;" class="editable-img">
                                                    <img editable="true" mc:edit="image007" src="{{ asset('email/images/icon-fb.png') }}" width="30" style="display:block; line-height:0; font-size:0; border:0;" border="0" alt="" />
                                                </a>
                                            </td>
                                            ...
                                            <td align="center" width="30">
                                                <a href="#" style="border-style: none !important; display: inline-block; border: 0 !important;" class="editable-img">
                                                    <img editable="true" mc:edit="image008" src="{{ asset('email/images/icon-twitter.png') }}" width="30" style="display:block; line-height:0; font-size:0; border:0;" border="0" alt="" />
                                                </a>
                                            </td>
                                            ...
                                            <td align="center" width="30">
                                                <a href="#" style="border-style: none !important; display: inline-block;; border: 0 !important;" class="editable-img">
                                                    <img editable="true" mc:edit="image009" src="{{ asset('email/images/icon-gp.png') }}" width="30" style="display:block; line-height:0; font-size:0; border:0;" border="0" alt="" />
                                                </a>
                                            </td>
                                        </tr>
                                    </table>
