...
<form id="cancelForm">
    ...
    <hr>
    <p class="reason">Reason for cancellation</p>
    ...
    <button type="submit" id="btn-cancel" class="btn">CONFIRM CANCELLATION</button>
</form>
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result.error == true) {
                    ...
                    $("#btn-cancel").html('CONFIRM CANCELLATION');
