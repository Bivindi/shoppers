        ...
        <div class="row">
            <div class="col-md-12">
                <div class="text-center">
                    <h1 class="wishlist-slider-title">Order details</h1>
                                ...
                                <div class="_2m1Usk">
                                    <div class="row _2ebRXN">
                                        <div class="col-5-12 _3dynR2 _3OsVcL">
                                            <div class="_1MbX3l"> {{ $address->first_name }} {{ $address->last_name }}</div>
                                            <div class="wRBMLW">{{ Auth::user()->email }}</div>
                                            <div class="_3N_1fR">
                                                {{ $address->address }},
                                                {{ $address->city }}
                                                <br>
                        ...
                        <div class="row">
                            <div class="col-sm-4 col-xs-12 block">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 _2eFO7I">
                                        <a href="{{ route('get:product_detail', $productOrder->slug) }}" target="_blank" rel="noopener noreferrer">
                                            <div class="_3BTv9X" style="height: 75px; width: 75px;">
                                                <img class="_1Nyybr  _30XEf0" alt="" src="{{ asset('100ProductImg/'.$productOrder->product_img) }}">
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-sm-8">
                            ...
                            <div class="col-sm-4 col-xs-12 block">
                                <div class="_2HvExN">
                                    ...
                                    <!-- Return link by me 02-08-2018 start-->
                                    @if($productOrder->shipping = \App\Model\Order::DELIVERED && $productOrder->shipping == \App\Model\Order::DELIVERED )
                                        <div class="_1S3Y5S  returnItem" transId="{{ $productOrder->transaction_id }}">
                                            <img src="{{ asset('img/cancel.svg') }}"
                                                 class="_3Q4GqT col-1-5">
                                            <span class="_3zvrLw col-3-5">Return Item</span>
                                        </div>
                                    @endif
                                    <!-- Return link by me 02-08-2018 over-->
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="_3YJBAw">
                                    <div class="">
                                        <span class="col-3-12 _2BU9FV"><img
                                          ...
                                          <!-- Ishwar -->
                                          @if($productOrder->shipping == \App\Model\Order::DELIVERED)
                                            <span class="">Delivered on {{ \Carbon\Carbon::parse($productOrder->delivery_date)->format("D, M dS 'y") }}</span>
                                            @else
                                             <span class="@if($productOrder->status == \App\Model\Order::CANCELED) mU1-I_ @endif">Delivery expected by {{ \Carbon\Carbon::parse($productOrder->delivery_date)->format("D, M dS 'y") }}</span>
                                            @endif
    ...
    <script>
        ...
        // for return item
         $(document).on('click', '.returnItem', function (e) {
            ...
            $.ajax({
                type: 'get',
                url: "{{ route('get:return_item_form') }}",
                data: {transId: transId},
                success: function (result) {
                    if (result.success == false) {
                        $.notify(result.message, "error");
                    }
                    $('.modal-title').html('Return Request');
                    $('.modal-body').html(result);
                }
            });
        });
