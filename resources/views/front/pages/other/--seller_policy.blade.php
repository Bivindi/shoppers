    ...
    <div class="columns-container">
        <div class="container" id="columns">
            ...
            <div class="breadcrumb clearfix">
                ...
                <span class="navigation_page">Seller Policy</span>
            </div>
            <!-- ./breadcrumb -->
            <!-- row -->
            <div class="row">
                        ...
                        <div class="block_content">
                            ...
                            <div class="layered layered-category">
                                <div class="layered-content">
                                    <ul class="tree-menu">
                                        <li class="active"><span></span><a href="{{ route('get:seller_policy') }}">Seller Policy</a></li>
                                        <li><span></span><a href="{{ route('get:privacy_policy') }}">Privacy Policy</a></li>
                                        <li><span></span><a href="{{ route('get:faq_support') }}">FAQ</a></li>
                                        <li><span></span><a href="{{ route('get:delivery_info') }}">Delivery Information</a></li>
                        ...
                        <div class="block left-module">
                            <div class="banner-opacity">
                                <a href="javascript:void(0);">
                                    <img src="{{ asset('otherpages/'.$sellerPolicy->image) }}"
                                         alt="ads-banner"></a>
                            </div>
                        </div>
                    @endif
                ...
                <div class="center_column col-xs-12 col-sm-9" id="center_column">
                    ...
                    <h2 class="page-heading">
                        <span class="page-heading-title2">Seller Policy</span>
                    </h2>
                    <!-- Content page -->
