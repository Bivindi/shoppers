    ...
    <section id="content">
            ...
            <div class="container">
                <div class="row">
                    <div class="col s12 m12 l12">
                        <h5 class="breadcrumbs-title">Seller Report</h5>
                        <ol class="breadcrumbs">
                            <li><a href="javascript:void(0);">Reports</a>
                            </li>
                            <li class="active">Seller Report</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <div class="col m12">
                        <div class="m4" style="margin-top: 10px;">
                            <a href="{{ route('get:seller_export_file', 'xlsx') }}" class="btn green">Excel</a>
                            <a href="{{ route('get:seller_export_file', 'csv') }}" class="btn green">CSV</a>
                            <a href="{{ route('get:seller_export_file', 'pdf') }}" class="btn green">PDF</a>
                        </div>
                    </div>
                    <div class="col m4">
