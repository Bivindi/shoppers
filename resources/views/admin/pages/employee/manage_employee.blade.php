            ...
            <div class="container">
                <div class="row">
                    <div class="col s12 m12 l12">
                        <h5 class="breadcrumbs-title">Manage Employee</h5>
                        ...
                        <table id="example" class="display responsive nowrap" cellspacing="0" width="100%">
                            ...
                            @foreach($users as $key => $user)
                                <tr>
                                    ...
                                    <td>
                                        @if($user->status == 1)
                                            <a class="waves-effect waves-light btn green btn-small"><i
                                                        class="fa fa-check"></i></a>
                                        @else
                                            <a class="waves-effect waves-light  btn red btn-small"><i
                                                        class="mdi-content-clear"></i></a>
                                        @endif
                                    </td>
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{ route('get:edit_employee', $user->slug) }}"
