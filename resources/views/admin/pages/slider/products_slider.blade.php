            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    <div class="card-panel">
                        ...
                        <div class="row">
                            <form id="formValidate" class="col s12" action="{{ route('post:products_slider') }}"
                                  method="post"
                                  enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col s12">
                                        <p>Products Main Slider</p>
                                        <input type="file" id="profile" name="main_slider" />
                                        <span class="help-block">Image upload 271*346 dimension</span>
                                    </div>
                                    <div class="col s12">
                                        <p>Products Main Slider Url</p>
            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    <div class="card-panel">
                        ...
                        <div class="row">
                            <form id="smallSlider" class="col s12" action="{{ route('post:products_slider') }}"
                                  method="post"
                                  enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col s12">
                                        <p>Slider</p>
                                        <input type="file" name="sidebar_slider" multiple/>
    ...
    <script type="text/javascript">
            ...
            $(document).on('click', '.removeImg', function (e) {
                ...
                swal({
                    ...
                    if (isConfirm) {
                        $.ajax({
                            type: 'get',
                            url: '{{ route('get:delete_product_slider') }}',
        ...
        $("#formValidate").validate({
            ...
            messages: {
                ...
                url: "Please select slider image..!",
            },
            errorElement: 'div',
