                        ...
                        <table id="example" class="display responsive nowrap" cellspacing="0" width="100%">
                            ...
                            @foreach($orders as $key => $order)
                                <tr>
                                    ...
                                    <td class="text-left">
                                        <button class="btn approve @if($order->cancel_approve != 1) green  @else btn-danger @endif"
                                                transId="{{ $order->transaction_id }}">@if($order->cancel_approve == 1)
                                                Approved @else Approve @endif</button>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
...
@section('page-js')
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.approve', function (e) {
            ...
            $.ajax({
                type: 'get',
                url: '{{ route('get:order_cancel_approve') }}',
