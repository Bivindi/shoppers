            ...
            <div class="container">
                <div class="row">
                    <div class="col s12 m12 l12">
                        <h5 class="breadcrumbs-title">Manage SubCategory</h5>
                        <ol class="breadcrumbs">
                            <li><a href="javascript:void(0);">SubCategory</a>
                            </li>
                            ...
                            @foreach($subcategories as $key => $subcategory)
                                <tr>
                                    ...
                                    @if(\Illuminate\Support\Facades\Auth::user()->hasRole('admin'))
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{ route('get:edit_subcategories', $subcategory->slug) }}"
        ...
        $(document).on('click', '.deleteMember', function (e) {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        type: 'get',
                        url: '{{ route('get:delete_subcategories') }}',
                        data: {slug: slug},
